...
ADDOBJ= fsInit.o freeSpace.o fileSystem.o parsePath.o fs_mkdir.o fs_isDir.o fs_readdir.o fs_isFile.o fs_opendir.o fs_getcwd.o fs_closedir.o fs_stat.o fs_setcwd.o fs_rmdir.o fs_delete.o b_io.o b_readHelpers.o b_writeHelpers.o manageFileSize.o
